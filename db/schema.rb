...
ActiveRecord::Schema[7.0].define(version: 2022_09_02_011136) do
  create_table "comunas", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nombre", limit: 30
    t.bigint "region_id", null: false
    t.index ["region_id"], name: "index_comunas_on_region_id"
  end

  create_table "curso_modulo_tutors", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "modulos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "descripcion", limit: 100
    t.integer "duracion_horas"
  end

  create_table "plan_formativos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "descripcion", limit: 100
    t.integer "duracion_horas"
    t.string "codigo_plan_formativo", limit: 30
  end

  create_table "plan_modulos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "plan_formativo_id", null: false
    t.bigint "modulo_id", null: false
