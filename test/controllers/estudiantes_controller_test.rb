...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { apellido_mat: @estudiante.apellido_mat, apellido_pat: @estudiante.apellido_pat, comuna_id: @estudiante.comuna_id, curso_id: @estudiante.curso_id, direccion: @estudiante.direccion, nombre: @estudiante.nombre, rut: @estudiante.rut } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { apellido_mat: @estudiante.apellido_mat, apellido_pat: @estudiante.apellido_pat, comuna_id: @estudiante.comuna_id, curso_id: @estudiante.curso_id, direccion: @estudiante.direccion, nombre: @estudiante.nombre, rut: @estudiante.rut } }
